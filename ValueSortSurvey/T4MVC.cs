...
{
    public static ValueSortSurvey.Controllers.HomeController Home = new ValueSortSurvey.Controllers.T4MVC_HomeController();
...
namespace Links
{
    ...
    public static class Content {
        ...
        public static readonly string ValueSort_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/ValueSort.min.css") ? Url("ValueSort.min.css") : Url("ValueSort.css");
